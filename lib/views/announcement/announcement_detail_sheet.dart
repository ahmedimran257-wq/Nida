...
class AnnouncementDetailSheet extends ConsumerWidget {
  ...
  Future<void> _handleBookmark(WidgetRef ref) async {
  ...
  void _handleShare(BuildContext context, String lang) {
    Share.share(
  ...
  void _handleReport(BuildContext context, String lang, WidgetRef ref) async {
  ...
  void _handleSetReminder(BuildContext context, WidgetRef ref) async {
                      ...
                      child: Row(
                        children: [
                          ...
                          if (isSaved) ...[
                            const SizedBox(width: 12),
                            IconButton(
                              onPressed: () => _handleSetReminder(context, ref),
                          ...
                          const SizedBox(width: 12),
                          IconButton(
                            onPressed: () => _handleShare(context, lang),
                          ...
                          const SizedBox(width: 12),
                          IconButton(
                            onPressed: () => _handleReport(context, lang, ref),
